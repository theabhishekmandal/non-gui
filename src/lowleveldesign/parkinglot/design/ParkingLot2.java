...
import lowleveldesign.parkinglot.design.parkingStrategy.LowestHeightParkingStrategy;
import lowleveldesign.parkinglot.design.parkingStrategy.MaxHeightParkingStrategy;
import lowleveldesign.parkinglot.design.parkingStrategy.ParkingStrategy;
...
public class ParkingLot2 implements IParkingLot {
    ...
    public void init(PrintStream printStream, int[][][] parking) {
        ...
        for (int i = 0; i < parking.length; i++) {
            parkingFloors[i] = new ParkingFloor(parking[i]);
        }
    }
    ...
    public boolean removeVehicle(String spotId) {
        ...
        return searchManager.remove(spotId);
    }
