...
public class CountWordsPresentInTrie {
    ...
    private static List<Integer> solve(String goodWords, ArrayList<String> hotelReviews){
        ...
        List<StoreWords> list = new ArrayList<>();
        int index = 0;
        ...
        for(String string : hotelReviews){
            ...
            list.add(StoreWords.of(string, contains, index++));
        }
        ...
        Comparator<StoreWords> comp = Comparator.comparing(StoreWords::getNumberOfWords).thenComparingInt(x -> -x.getOrder());
