...
public class StreamFromCsvFile {
    ...
    private static void third(String csvFilePath) throws Exception{
    ...
    private static void second(String csvFilePath) throws Exception{
    ...
    private static void first(String csvFilePath) throws Exception{
