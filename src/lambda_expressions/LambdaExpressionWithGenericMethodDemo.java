...
public class LambdaExpressionWithGenericMethodDemo {

    static <T> int myOp(TestFuncNew<T> arr, T[] vals, T v){
    ...
    public static void main(String[] args) {
        ...
        count = myOp(Test::countMatching, vals, 4);
        System.out.println("vals contains " + count +" 4s");

        count = myOp(Test::countMatching, strs, "Two");
